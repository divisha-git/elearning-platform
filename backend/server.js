...
// Load environment variables (prefer .env in dev; production uses platform env)
...
// Behind proxies/load balancers on hosts like Railway/Render
app.set('trust proxy', 1);

// Allowed origins from env (comma-separated). Empty => allow all.
